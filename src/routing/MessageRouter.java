...
public abstract class MessageRouter {
	...
	public boolean removeIncoming(){
		String id=null;
		for (String str:incomingMessages.keySet()) {
			id=str;
		}
	...
	public void deleteMessage(String id, boolean drop)  {
		...
		//throw new ScenarioUndefined("i did call you");
	}
	...
	public Collection<Collection<Application>>  getApplications() {
