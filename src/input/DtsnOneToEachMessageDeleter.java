 ...
 */
public class DtsnOneToEachMessageDeleter extends MessageEventDeleter{
	//private final static String APP_ID="dtsn";//"srwsn";//"dtsn";//"stdp";
	private List<Integer> toIds;
	
	double prob=1;

	public DtsnOneToEachMessageDeleter(Settings s) {
		super(s);
	...
	public ExternalEvent nextEvent() {
		...
		RandomMessageDeleteEvent mce = new RandomMessageDeleteEvent( to, getID(),this.nextEventsTime,true,prob);
