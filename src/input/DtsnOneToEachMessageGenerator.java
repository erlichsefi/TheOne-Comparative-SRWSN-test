 ...
 */
public class DtsnOneToEachMessageGenerator extends MessageEventGenerator {
	public   static String APP_ID="dtsn";//"srwsn";//"dtsn";//"stdp";
	private List<Integer> toIds;

	public DtsnOneToEachMessageGenerator(Settings s) {
		super(s);
