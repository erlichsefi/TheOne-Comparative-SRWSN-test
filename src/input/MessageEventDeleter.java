 ...
 * be configured.
 */
public class MessageEventDeleter implements EventQueue {
	 ...
	 */
	public MessageEventDeleter(Settings s){
	...
	public ExternalEvent nextEvent() {
		...
		RandomMessageDeleteEvent mce = new RandomMessageDeleteEvent(to, "#",DropTime,true,1);
