 ...
 */
public class SimpleBroadcastInterfaceWithLost extends NetworkInterface {
	
	
	/**
	 * Reads the interface settings from the Settings file
	 */
	public SimpleBroadcastInterfaceWithLost(Settings s)	{
		super(s);
	}
	 ...
	 */
	public SimpleBroadcastInterfaceWithLost(SimpleBroadcastInterfaceWithLost ni) {
		super(ni);
	}

	public NetworkInterface replicate()	{
		return new SimpleBroadcastInterfaceWithLost(this);
	}
